# Generated by Django 3.2.20 on 2023-09-15 13:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='s1_blog.post')),
            ],
            options={
                'ordering': ['created_on'],
            },
